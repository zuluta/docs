...
diseño mucho mas moderno. Abre la terminal de VSCode, detenemos el servidor con las teclas (ctrl + c), activa el entorno virtual, accede a la carpeta “mi-documentación” y desde ahí ejecuta el comando “pip install mkdocsmaterial”.
